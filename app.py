...
def load_data():
    ...
    # FIX VARIABILI: Uso COURT_WIDTH e COURT_HEIGHT definiti sopra
    ...
    if c1.button("Genera Metriche"):
        with st.spinner("Calcolo..."):
            ...
            if moves:
                ...
                k1, k2 = st.columns(2)
                k1.info(f"🔴 Red: Tot {atr:.1f}m | Off {aro:.1f}m | Spd {asr:.1f}km/h | Poss {apr:.1f}s")
